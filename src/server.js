...
const instructorController = require("./controllers/instructor/index");
...
const quiz_scoreController = require("./controllers/quiz_score/index");
...
app.use("/api/quiz_score", quiz_scoreController);
